...
def main(original_url):
    ...
    # with open('httpx.html', 'wb') as f:
    #     for chunk in res.iter_content(100000):
    #         f.write(chunk)

    regex=re.compile(r'[^a-zA-Z0-9(). :_\u4e00-\u9fa5]')
    f=open('httpx.html','r', encoding='UTF-8')
    soup=bs4.BeautifulSoup(f.read(),'html.parser')
    # print(soup.prettify())
    tags=soup.find_all(class_ = 'md-nav__link')
    ...
    #     downthread=threading.Thread(target=downfile, args=(i, i+5))
